					...
					<div class="navbar navbar-inverse">
			    		<div class="navbar-inner">
							  ...
							  <ul class="nav">
                                    ...
                                    <li class="active"><a href="detail.php">Cart</a></li>
			              			<li class="dropdown">
...
<tr>
					...
					<th><center>Nama Bunga</center></th>
    ...
    //mysql_select_db($database_conn, $conn);
            ...
            ?>
				...
				if($total == 0){
					...
					echo '
						<tr style="background-color: #DDD;"><td colspan="7" align="right"><b>Total :</b></td><td align="right"><b>Rp. '.number_format($total,2,",",".").'</b></td></td></td><td></td></tr></table>
						<p><div align="right">
