			            		...
			            		<ul class="nav">
                                    ...
                                    <li class="dropdown">
			                			...
			                			<ul class="dropdown-menu">
											  ...
											  <li class="active" ><a href="produk_funeral.php">Funeral Flower</a></li>
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Funeral Flower</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk_funeral order by kode DESC");
		...
		while($data = mysqli_fetch_assoc($sql)){
        		...
        		<div class="span4">
          			<div class="icons-box">
                        ...
                        <img src="../admin/<?php echo $data['gambar']; ?>" style="border: 2px solid grey; border-radius: 5px; width: 150px; height: 200px;"/>
						<div><h3>Rp.<?php echo number_format($data['harga'],2,",",".");?></h3></div>
					<!--	<p>
						
						</p> -->
						<div class="clear"><a href="DetailProdukFuneral.php?hal=detailbarang&kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Detail</a>  <a href="funeralAddtoCart.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-success">Beli &raquo;</a></div>
