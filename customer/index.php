    	...
    	<div class="container">
			  ...
			  <hr>
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Detail</a> <a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="clear"> <a href="addtocart.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-success">Beli &raquo;</a></div>
			...
			<hr>
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="DetailProdukFuneral.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Detail</a> <a href="DetailProdukFuneral.php?kd=<?php echo $data['kode'];?>" class="clear"> <a href="funeralAddtoCart.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-success">Beli &raquo;</a></div>
			...
			<hr>
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="DetailProdukGraduate.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Detail</a> <a href="DetailProdukGraduate.php?kd=<?php echo $data['kode'];?>" class="clear"> <a href="graduateAddtoCart.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-success">Beli &raquo;</a></div>
			...
			<div class="span4">
				...
				<!--	<p>
					...
					<div class="clear"><a href="DetailProdukTangkai.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Detail</a> <a href="DetailProdukTangkai.php?kd=<?php echo $data['kode'];?>" class="clear"> <a href="tangkaiAddtoCart.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-success">Beli &raquo;</a></div>
