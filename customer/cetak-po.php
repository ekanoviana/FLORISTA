...
$result=mysqli_query($koneksi, "SELECT po_terima.*, konfirmasi.jumlah, produk.kode AS kode_prod, produk.nama, produk.harga, customer.alamat, customer.no_telp, customer.nama AS nama_cus, po.status FROM po_terima
				...
				WHERE po_terima.nopo='$_GET[kd]'") or die(mysqli_error($koneksi));
...
// $pdf->Image('../img/floristalogo.png',10,10,-175);
...
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'Toko Bunga Florista',0,0,'C');
$pdf->Ln();
...
$pdf->SetX(45);
$pdf->Cell(60,8,'Nama Bunga',1,0,'C',1);
$pdf->SetX(105);
