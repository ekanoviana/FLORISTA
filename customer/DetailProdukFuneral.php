...
<body>
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Detail Flower</h2>
	...
	<!--start: Wrapper-->
            ...
            <div class="col-sm-6">
                    <?php                  
$query = mysqli_query($koneksi, "SELECT * FROM produk_funeral WHERE kode='$_GET[kd]'");
...
?>
        		<!--<div class="span4">-->
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
						<td><div class="clear"> <a href="funeralAddtoCart.php?kd=<?php echo $data['kode']; ?>" class="btn btn-lg btn-success">Beli</a></div></td>
                        </tr>                                  
