                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                            ...
                            <option value="Makanan">Wedding Bouquet</option>
                            <option value="Minuman">Funeral Flowers</option>
                            <option value="Camilan">Graduation Flowers</option>
                            <option value="Camilan">Single Flowers</option>
                            </select>
